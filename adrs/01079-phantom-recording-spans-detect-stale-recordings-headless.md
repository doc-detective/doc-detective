...
- A headless run must never write anything: no video, no baseline seeding or updates (it can't produce the video the baselines must stay in sync with — ADR 01078's atomicity).

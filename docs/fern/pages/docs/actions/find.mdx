...
**Outputs:** the action also exposes `outputs.found`, a boolean indicating whether an element matching your criteria was located. Reference it with the `$$outputs.*` namespace as `$$outputs.found`.

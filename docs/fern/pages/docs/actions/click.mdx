...
**Setting Variables:** When you target an element by text or selector, the action exposes `$$found`, a boolean indicating whether the element was located. Reference it in later steps through the step-level `variables` object.

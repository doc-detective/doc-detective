...
To move between **points** instead of elements — carousels, sliders, plain scrolling — use [`swipe`](swipe), the movement subset of this action: `dragAndDrop` locates two elements and moves between them; `swipe` moves between two coordinates (or a direction shorthand).

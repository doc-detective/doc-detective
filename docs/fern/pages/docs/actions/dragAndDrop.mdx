...
**Setting Variables:** The action exposes `$$sourceFound` and `$$targetFound`, booleans indicating whether the source and target elements were located. Reference them in later steps through the step-level `variables` object.

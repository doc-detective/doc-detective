...
**Setting Variables:** the action exposes `$$sourceFound` and `$$targetFound`, Boolean values indicating whether the source and target elements were located. Reference them in later steps through the step-level `variables` object.

...
- `surface`: (Optional) The browser window or tab the source and target elements live in, e.g. `{ "browser": "chrome", "tab": "board" }`. Omit to act on the active tab. See [Test across multiple tabs and windows](/docs/test-docs/multiple-tabs-and-windows).

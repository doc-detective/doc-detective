...
Depending on which validations you configure, the action also exposes the result of each check as a boolean you can reference. Each output is present only when its check applies:

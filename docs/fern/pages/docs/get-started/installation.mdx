...
3. Run a test, pointing to the file you just created:
    ...
    The Linux image supports both amd64 and arm64 architectures. On Apple Silicon, AWS Graviton, or Raspberry Pi, Docker automatically pulls the native arm64 image.

...
If tests fail, you can automatically create a GitHub issue to track the problem. You can also trigger [integrations](/docs/test-docs/integrations) to investigate and fix failures.
...
| `integrations` | None | Comma-separated integrations to trigger (see [Integrations](/docs/test-docs/integrations)) |

...
DITA OT and other XML processors encode reserved characters in attribute values. Doc Detective decodes these entities before parsing:
...
## Loading DITA content from Heretto

If you manage your DITA content in Heretto, Doc Detective can load it directly from your Heretto CCMS. See [Heretto integration](/docs/test-docs/heretto) for configuration details.
...
- See [Heretto integration](/docs/test-docs/heretto) to load DITA content from Heretto CCMS

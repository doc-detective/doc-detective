...
If you manage your DITA content in Heretto, Doc Detective can load it directly from your Heretto CCMS. See [Heretto integration](/docs/integrations/heretto) for configuration details.

## Next steps

- Learn about [inline tests](/docs/tests/inline) for manual test definition
...
- See [Heretto integration](/docs/integrations/heretto) to load DITA content from Heretto CCMS

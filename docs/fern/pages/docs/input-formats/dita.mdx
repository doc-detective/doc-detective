...
If you manage your DITA content in Heretto, Doc Detective can load it directly from your Heretto CMS. See [Heretto integration](heretto) for configuration details.
...
- See [Heretto integration](heretto) to load DITA content from Heretto CMS

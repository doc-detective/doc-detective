...
> You can mix detected tests with [inline tests](/docs/test-docs/inline) to declare steps that might not be covered in your content, such starting or stopping a recording.

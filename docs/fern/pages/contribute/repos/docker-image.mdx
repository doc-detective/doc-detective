...
[`docker-image`](https://github.com/doc-detective/docker-image) runs Doc Detective in a container. Doc Detective runs on most machines as-is. This Docker image simplifies installing and running it on machines without Node.js, or with heightened security requirements.

...
3. **Run tests in Docker** (mimics CI environment):
   ```bash
   docker run --rm -v $(pwd):/app -w /app node:22 npm run doc-detective
   ```
...
- **Doc Detective docs**: [Test documentation](/docs/get-started/how-testing-works)
...
- **Learn more**: Read the [full test documentation](/docs/get-started/how-testing-works)

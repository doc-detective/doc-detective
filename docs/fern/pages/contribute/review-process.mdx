...
5. **Claude AI review**: Provides automated code review feedback on your PR
...
Mention `@claude` in a comment to get AI-powered help at any point during your contribution.

### Where to use @claude

- **Issue comments**: Ask Claude to investigate or fix an issue
- **PR comments**: Get help with code changes, tests, or documentation
- **PR review comments**: Ask follow-up questions about review feedback

### What Claude can help with

- Answering questions about the codebase
- Suggesting bug fixes or improvements
...
1. Write a comment mentioning `@claude` followed by your request
2. Claude responds in the same thread with suggestions or changes
3. Review the response and continue the conversation if needed

Claude has read access to the repository and can reference existing code and documentation when helping you.

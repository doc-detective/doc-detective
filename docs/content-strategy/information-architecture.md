...
| Last verified on | W2 | | `verified` marker write-back and `badge: true` inline-test flag: stamps a page with the date its test/spec last passed, optional shields.io badge. |

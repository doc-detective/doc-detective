...
/**
 * Stops an active recording, finalizes the recorded file, performs any required conversion, and returns the operation result.
 *
 * @param config - Runtime configuration containing recording state (e.g., `recording.tab`, `recording.downloadPath`, `recording.targetPath`). The function may clear `config.recording` on success.
